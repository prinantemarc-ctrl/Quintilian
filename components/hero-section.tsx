    ...
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center py-12 sm:py-16 md:py-20 overflow-hidden bg-black">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-8 sm:space-y-12">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-2.5 sm:px-3 py-0.5 sm:py-1 border border-red-900/50 bg-red-950/10 text-red-500 text-[10px] sm:text-xs font-medium uppercase tracking-widest mb-6 sm:mb-8">
          ...
          {/* Main Title - Remplacé font-serif par font-heading (Manrope) */}
          <div className="space-y-4 sm:space-y-6">
            ...
            {/* Subtitle - Remplacé font-mono par font-sans */}
          ...
          <div className="max-w-3xl mx-auto mt-8 sm:mt-12">
              ...
              <div className="bg-zinc-950/50 p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                  <div className="space-y-2 text-left">
                    <Label className="text-xs font-medium text-red-500 uppercase tracking-wider flex items-center gap-2">
                    ...
                    <Input
                      ...
                      className="bg-black border-zinc-800 focus:border-red-900 text-white placeholder:text-zinc-700 h-12 rounded-none"
                    />
                  </div>

                  <div className="space-y-2 text-left">
                    <Label className="text-[10px] sm:text-xs font-medium text-red-500 uppercase tracking-wider flex items-center gap-2">
                    ...
                    <Textarea
                      ...
                      className="min-h-[80px] sm:min-h-[100px] text-sm sm:text-base resize-none border-zinc-800 focus:border-red-900 text-white bg-background/50"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2 text-left">
                  ...
                  >
                    <SelectTrigger className="bg-black border-zinc-800 focus:border-red-900 text-white h-12 rounded-none">
                ...
                <Button
                  ...
                  className="w-full h-12 sm:h-14 bg-red-700 hover:bg-red-600 text-white font-medium uppercase tracking-[0.15em] sm:tracking-[0.2em] text-xs sm:text-sm rounded-none border border-transparent hover:border-red-400 transition-all duration-300 disabled:opacity-50 disabled:grayscale"
                >
            ...
            {/* Status Line - Remplacé font-mono par font-medium */}
