          ...
          <div className="p-8">
                ...
                <div className="flex items-center justify-center gap-4 mb-4">
                  ...
                  <div className="text-center">
                    <h2 className="text-2xl font-bold text-yellow-800">
                      {results.bestCountry.flag} {results.bestCountry.country} remporte !
                    </h2>
                    <p className="text-yellow-700">Score global : {results.bestCountry.globalScore}/100</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              <Card>
                ...
                <CardContent>
                  <div className="flex items-center gap-3">
                    <span className="text-3xl">{results.bestCountry.flag}</span>
                    <div>
                      <div className="font-semibold">{results.bestCountry.country}</div>
                      <div className="text-2xl font-bold text-green-600">{results.bestCountry.globalScore}/100</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex items-center gap-3">
                    <span className="text-3xl">{results.worstCountry.flag}</span>
                    <div>
                      <div className="font-semibold">{results.worstCountry.country}</div>
                      <div className="text-2xl font-bold text-red-600">{results.worstCountry.globalScore}/100</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
