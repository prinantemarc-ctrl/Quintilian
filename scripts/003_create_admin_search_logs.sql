-- Create search_logs table for admin access to all searches
CREATE TABLE IF NOT EXISTS public.search_logs (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  
  -- Search parameters
  type TEXT NOT NULL CHECK (type IN ('analyze', 'duel', 'world')),
  query TEXT NOT NULL,
...
-- Allow all operations for admin access (you can restrict this later)
